...
import { IconFloatWindowOutline16, IconPanelBottomOutline16 } from '../icons.tsx'
import {
  LucideCircleDashedCheck, LucideFolder, LucideGlobe, LucideListChecks, LucideMessageCircleMore, LucideSquareTerminal,
} from '../icons.tsx'
  ...
  return [
    {
      ...
      title: () => t('files'),
      icon: (size: number) => <LucideFolder size={size} />,
      order: 10,
      hidden: false,
    ...
    },
    {
      ...
      id: 'git',
      title: () => t('changes'),
      icon: (size: number) => <LucideCircleDashedCheck size={size} />,
      order: 20,
      single: true,
      badge: (_ctx, scope) => {
    ...
    },
    {
      id: 'subagent',
      title: () => t('subagent'),
      icon: (size: number) => <LucideListChecks size={size} />,
      order: 30,
      single: true,
    ...
    },
    {
      id: 'sidechat',
      title: () => t('sideChat'),
      icon: (size: number) => <LucideMessageCircleMore size={size} />,
      order: 35,
    ...
    },
    {
      id: 'terminal',
      title: () => t('terminal'),
      icon: (size: number) => <LucideSquareTerminal size={size} />,
      order: 40,
    ...
    },
    {
      id: 'browser',
      title: () => t('browser'),
      icon: (size: number) => <LucideGlobe size={size} />,
      order: 50,
